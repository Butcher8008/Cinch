                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "Redesign the homepage of our website to improve \nuser engagement and align with our updated bran",
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "Optimize the user interface for our mobile app \nensuring a seamless and delightful user experiene",
                          style: TextStyle(color: Colors.grey, fontSize: 14),
                        ),
                        const SizedBox(
                          height: 15,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "Redesign the checkout process for our e-comm..\nerce platform, focusing on improving conve...",
                          style: TextStyle(color: Colors.grey, fontSize: 14),
                        ),
                        const SizedBox(
                          height: 15,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "Design the user interface for a new feature integ..\nration within our existing platform. Ensure the..",
                          style: TextStyle(color: Colors.grey, fontSize: 14),
                        ),
                        const SizedBox(
                          height: 15,
