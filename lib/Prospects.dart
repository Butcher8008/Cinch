import 'package:cinch/Colors/Colors.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text('Company Name',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,fontFamily: "poppins"),),
                                    Padding(
                                      padding: EdgeInsets.only(right: 8),
                                      child: Text(value['companyName'].toString(),style: TextStyle(fontSize: 20,),),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 5,),
                                 Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text("Contact Name ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,fontFamily: "poppins"),),
                                    Padding(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(width: 10,),
                                              Text(value['email'].toString(),style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold),)
                                            ],
                                          ),
                                          SizedBox(height: 5,),
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 10,),
                                              Text(value['date'].toString(),style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold),)
                                            ],
                                          )
